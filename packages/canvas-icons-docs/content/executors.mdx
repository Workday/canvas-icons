...
| :----------- | :------: | :-----------------------------: | :------------------------------------------------ |
| `iconType`   | ✅ true  | `accent`, `applet`, or `system` | Icon type to get correct file paths and ts types. |
...
```js filename="canvas-graphics-web/project.json" {5-11}
{
  "name": "@workday/canvas-graphics-web",
...
```bash
nx run @workday/canvas-graphics-web:icon-es6
```

<Callout type="warning" emoji="⚠️">
  Required options have to be specified in `project.json` or/and in bash command
</Callout>
